...
try:
  ...
  with connection.cursor() as cursor:
       with open (r'C:\Users\nbelovolova\Desktop\Проект\файлы\ft_balance_f.csv', encoding='utf-8-sig') as file:
           next(file)
           cursor.copy_from(file, 'ft_balance_f', sep=';')
       with open (r'C:\Users\nbelovolova\Desktop\Проект\файлы\ft_posting_f.csv', encoding='utf-8-sig') as file:
           next(file)
           cursor.copy_from(file, 'ft_posting_f', sep=';')
       with open (r'C:\Users\nbelovolova\Desktop\Проект\файлы\md_account_d.csv', encoding='utf-8-sig') as file:
           next(file)
           cursor.copy_from(file, 'md_account_d', sep=';')
       with open (r'C:\Users\nbelovolova\Desktop\Проект\файлы\md_currency_d.csv', encoding='cp1252') as file:
           next(file)
           cursor.copy_from(file, 'md_currency_d', sep=';')     
       with open (r'C:\Users\nbelovolova\Desktop\Проект\файлы\md_ledger_account_s.csv', encoding='utf-8-sig') as file:
           next(file)
  ...
  with connection.cursor() as cursor:
      ...
      with open (r'C:\Users\nbelovolova\Desktop\Проект\файлы\md_exchange_rate_d.csv', encoding='utf-8-sig') as file:
           next(file)
